...
<body>
	...
	<header id="fh5co-header-section" class="sticky-banner">
		...
		<div class="nav-header navbar navbar-expand-lg navbar-dark p-md-3 bg-dark" style="padding:0 0.8vw !important; border-radius:0;background-color:#212529 !important;">
			<h1 id="fh5co-logo" style="margin:0 0 0 0;"><a href="{{ url('/') }}"><img src="{{ asset ("img/logo_primary.png") }}" style="height:54px;"></a></h1>
			<!-- START #fh5co-menu-wrap -->
			
			
			<nav id="fh5co-menu-wrap" role="navigation" style="margin-top:0;margin-left:16vw;">
			
					
				<ul class="sf-menu" id="fh5co-primary-menu" style="margin-top:0!important;">
					<li class="{{ (request()->route()->getName()=='dashboard')?'active':''}}"><a class="nav-link text-white" href="{{ url('/') }}">Home</a></li>
					<li>
					...
					@auth
						<li class="login {{ (preg_match('/profile/i',request()->route()->getName())==1)?'active':''}}"><a class="{{ (preg_match('/profile/i',request()->route()->getName())==1)?'':'nav-link text-white'}}" href="{{ url('/home/profile') }}">Account</a></li>
					@else
