            ...
            <div class="row row-bottom-padded-md">
                <div class="card" style="border-readius:5%;">
                            ...
                            <div class="card" style="display:inline-block; margin:20px 10px 0 0">
                                <div class="col-md-4" style="padding:0;">
                                    <div class="card rounded">
                                        <img class="img-responsive" src="{{ $dest->image }}" style="border-radius: 2%;"> 
                                    </div>
                                </div>
                                <div class="col-md-8" style="padding:0;">
                                    <div class="card rounded">
                                        <div class="card-body">
                                            <h3 class="card-title" style="font-size:25px;"> {{ $dest->name }}</h3>   
                                            <br>
                                            <span style="font-size:20px;font-weight: 400;">Description:</span>
                                            <p style="text-align:justify;"> {{ $dest->description }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12" style="margin-top:60px;">
                        <div class="row">
                            <h1> <span class="fas fa-hamburger "></span> Restaurants</h1>
                            <br>
                            @foreach($restaurants as $rest)
                            <div class="card" style="display:inline-block; margin:20px 10px 0 0">
                                <div class="col-md-4" style="padding:0;">
                                    <div class="card rounded">
                                        <img class="img-responsive" src="{{ $rest->image }}" style="border-radius: 2%;"> 
                                    </div>
                                </div>
                                <div class="col-md-8" style="padding:0;">
                                    <div class="card rounded">
                                        <div class="card-body">
                                            <h3 class="card-title" style="font-size:25px;"> {{ $rest->name }} </h3>   
                                            <br>
                                            <span style="font-size:20px;font-weight: 400;">Description:</span>
                                            <p style="text-align:justify;">{{ $rest->description }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
