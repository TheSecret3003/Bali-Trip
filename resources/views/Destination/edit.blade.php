...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Update Destinasi</h1>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="card card-primary">
            <form method="POST" action="{{ route('destination.update', $destination->id)}}" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                      <textarea rows="6" input  id="description" 
                              ...
                              placeholder="{{ old('description') ?? $destination->description}}">{{ $destination->description}}</textarea>
                ...
                <div class="form-group row">
                  <label for="image" class="col-md-4 col-form-label text-md-right">Gambar Destinasi</label>
                  ...
                  <div class="col-md-6">
                      ...
                      <a href="{{ $destination->image() }}">{{ ($destination->image)?'Last uploaded image':'' }}</a>
                      @error('image')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
